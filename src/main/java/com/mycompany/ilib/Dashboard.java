...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_returns1 = new javax.swing.JButton();
        ...
        menu.setBackground(new java.awt.Color(37, 108, 178));
        menu.setPreferredSize(new java.awt.Dimension(270, 640));

        appName.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        appName.setText("Póliza de Seguro");

        jSeparator1.setPreferredSize(new java.awt.Dimension(50, 5));

        btn_prin.setBackground(new java.awt.Color(37, 108, 178));
        ...
        btn_lends.setBackground(new java.awt.Color(37, 108, 178));
        ...
        btn_lends.setText("Actas de defunciones");
        ...
        btn_returns.setBackground(new java.awt.Color(37, 108, 178));
        ...
        btn_returns.setText("Pólizas de seguro");
        ...
        btn_returns1.setBackground(new java.awt.Color(37, 108, 178));
        btn_returns1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btn_returns1.setForeground(new java.awt.Color(255, 255, 255));
        btn_returns1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/calendar-plus.png"))); // NOI18N
        btn_returns1.setText("Ver Actas");
        btn_returns1.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 13, 1, 1, new java.awt.Color(0, 0, 0)));
        btn_returns1.setBorderPainted(false);
        btn_returns1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btn_returns1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btn_returns1.setIconTextGap(13);
        btn_returns1.setInheritsPopupMenu(true);
        btn_returns1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_returns1ActionPerformed(evt);
            }
        });

        btn_lends1.setBackground(new java.awt.Color(37, 108, 178));
        btn_lends1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btn_lends1.setForeground(new java.awt.Color(255, 255, 255));
        btn_lends1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/account-multiple.png"))); // NOI18N
        btn_lends1.setText("Ver Pólizas");
        ...
        menuLayout.setHorizontalGroup(
            ...
            .addComponent(btn_returns1, javax.swing.GroupLayout.DEFAULT_SIZE, 270, Short.MAX_VALUE)
            .addComponent(btn_lends1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        menuLayout.setVerticalGroup(
            ...
            .addGroup(menuLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btn_returns1, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btn_lends1, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );

        header.setBackground(new java.awt.Color(16, 75, 133));
        header.setPreferredSize(new java.awt.Dimension(744, 150));

        navText.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        navText.setText("Administración/Control");

        dateText1.setText("Hoy es {dayname} {day} de {month} de {year}");
        ...
        headerLayout.setHorizontalGroup(
            ...
            .addGroup(headerLayout.createSequentialGroup()
                ...
                .addGroup(headerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(navText, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(dateText))
                .addContainerGap(558, Short.MAX_VALUE))
            .addGroup(headerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(headerLayout.createSequentialGroup()
                    .addGap(163, 163, 163)
                    .addComponent(dateText1, javax.swing.GroupLayout.DEFAULT_SIZE, 434, Short.MAX_VALUE)
                    .addGap(163, 163, 163)))
        );
        headerLayout.setVerticalGroup(
            ...
            .addGroup(headerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(headerLayout.createSequentialGroup()
                    .addGap(222, 222, 222)
                    .addComponent(dateText1, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        mensaje.setText("Gestión de Administración Santa Elena");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(background, javax.swing.GroupLayout.DEFAULT_SIZE, 1068, Short.MAX_VALUE)
        );
...
ShowJPanel(new Returns());        
    ...
    private void btn_returnsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_returnsActionPerformed
        ShowJPanel(new PolizasSeguro());
    }//GEN-LAST:event_btn_returnsActionPerformed

    private void btn_returns1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_returns1ActionPerformed
   ShowJPanel(new VerActa()); 
    }//GEN-LAST:event_btn_returns1ActionPerformed

    private void btn_lends1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_lends1ActionPerformed
     ShowJPanel(new VerPolizas()); 
    ...
    private javax.swing.JButton btn_returns1;
